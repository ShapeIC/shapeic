...
def ota_2stage_opt():
    ...
    xhi = np.array([100e-6, 6.4e-6, 100e-6, 6.4e-6, 100e-6, 6.4e-6])
    xinit = np.array([5e-6, 0.5e-6, 10e-6, 0.5e-6, 10e-6, 0.5e-6])
    ...
    requirements = [
        ...
        {
            "measure": "isupply",
            "norm": Nbelow(40e-6, 5e-6),     # corriente <= 20 uA
        },
        {
            "measure": "area",
            "norm": Nbelow(1e-6, 20e-12), # area ideal <= 80 um^2
        },
    ]
