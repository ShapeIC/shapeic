...
sns.scatterplot(data=df_shapeic, x = "area", y = "dc_gain_db", ax=axes[0,0], hue="ro_ota_ohm")
...
sns.scatterplot(data=df_shapeic, x = "area", y = "phase_margin_deg", ax=axes[1,1], hue="ro_ota_ohm")
